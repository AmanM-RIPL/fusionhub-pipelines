...
void ColumnGeometryService::updateGeometry(BIMElement *columnElement, const QVector3D &point)
{
    ...
    QList<BIMParameter*> parameterList = columnElement->getParameterList();
...
void ColumnGeometryService::generateWIPMesh2D(BIMElement *columnElement, Mesh *mesh, const QVector3D &point, const Point& screen_point, View *view, QList<HelperPoint> &helperPoints)
{
    std::vector<std::vector<Point>> polygon;
    std::vector<Point> referenceLine = {};
    float width = 0;
...
Point ColumnGeometryService::updatePoint2D(BIMElement *columnElement, const QList<HelperPoint> &helperPoints, const Point &screen_point, View *view)
{
    std::vector<std::vector<Point>> polygon;
    std::vector<Point> referenceLine = {};
    float width = 0;
...
void ColumnGeometryService::generateHelperPoints(BIMElement *bimElement, QList<HelperPoint> &helperPoints)
{
    HelperPoint length;
    HelperPoint angle;
