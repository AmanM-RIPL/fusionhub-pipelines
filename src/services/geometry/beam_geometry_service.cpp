...
void BeamGeometryService::generateWIPMesh2D(BIMElement *beamElement, Mesh *mesh, const QVector3D &point, const Point& screen_point, View *view, QList<HelperPoint> &helperPoints)
{
    std::vector<std::vector<Point>> polygon;
    std::vector<Point> referenceLine = {};
    float width = 0;
...
Point BeamGeometryService::updatePoint2D(BIMElement *beamElement, const QList<HelperPoint> &helperPoints, const Point &screen_point, View *view)
{
    std::vector<std::vector<Point>> polygon;
    std::vector<Point> referenceLine = {};
    float width = 0;
...
void BeamGeometryService::generateHelperPoints(BIMElement *bimElement, QList<HelperPoint> &helperPoints)
{
    HelperPoint length;
    HelperPoint angle;
