...
public:
    ...
    Q_INVOKABLE void approvedCreate(int workOrderId,const QString &description, double dollarValue,double taxAmount, double taxWithholdingAmount,int taskId,double retentionAmount) const;
