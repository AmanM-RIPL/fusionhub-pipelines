...
export default class VendorDao implements IProjectEntityBaseRepository {
  ...
  public create(changeLog: Selectable<IChangeLog>): void {
    ...
    const statement = this.db.prepare("INSERT INTO Vendor (global_id, approval_status, vendor_name, vendor_address, vendor_contact_person, vendor_mobile, vendor_email, change_history) VALUES (?, ?, ?, ?, ?, ?, ?)");
