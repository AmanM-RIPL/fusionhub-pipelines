...
#include <memory>
class WorkBillingLineRepository : public AbstractRepository<WorkBillingLine> {
public:
    WorkBillingLineRepository();
    std::unique_ptr<WorkBillingLine> findById(int id) override;
