#ifndef EARCUT_ALGORITHM_H
#define EARCUT_ALGORITHM_H

/*
    The following EarCut 2D Polygon Triangulation Algorithm has been obtained
    from https://github.com/mapbox/earcut.hpp?tab=readme-ov-file#usage

    The Algorithm is O(n^2). Maybe there are areas of improvement later.
*/
