...
RepositoryLocator::RepositoryLocator() {
    ...
    m_workBillingRepository = std::make_unique<WorkBillingRepository>();
...
WorkBillingRepository *RepositoryLocator::workBillingRepository()
{
    return m_workBillingRepository.get();
}
